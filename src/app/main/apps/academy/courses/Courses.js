		...
		<div className="flex flex-col flex-auto flex-shrink-0 w-full">
				...
				<div className="flex flex-col max-w-2xl mx-auto w-full p-24 sm:p-32">
					<motion.div initial={{ opacity: 0 }} animate={{ opacity: 1, transition: { delay: 0 } }}>
						<Typography color="inherit" className="text-24 sm:text-44 font-bold tracking-tight">
							Retrouvez ici les différentes thématiques G-TRM
						</Typography>
					</motion.div>
					<motion.div initial={{ opacity: 0 }} animate={{ opacity: 1, transition: { delay: 0.3 } }}>
						...
						>
							Les différents guides sont là pour vous guider à travers les diverses thématiques sécurité, compliance, gouvernance etc.
						</Typography>
					</motion.div>
				</div>
			...
			<div className="flex flex-col flex-1 max-w-2xl w-full mx-auto px-8 sm:px-16 py-24">
				<div className="flex flex-col flex-shrink-0 sm:flex-row items-center justify-between py-24">
					<TextField
						label="Chercher une thémathique"
					...
					<FormControl className="flex w-full sm:w-320 mx-16" variant="outlined">
						<InputLabel htmlFor="category-label-placeholder"> Catégories </InputLabel>
						<Select
